...
@section('content')
	<div class="flex w-full flex-col items-start space-x-2 bg-white p-4 shadow-lg">
		...
		<div id="STATUS COUNT" class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-4">
			...
			<div id="PENDING DOCUMENTS" class="flex w-fit items-center space-y-2 rounded-md border-l-8 border-green-700 bg-green-500 p-4 shadow-md">
				<div class="flex flex-col justify-between">
					<h1 class="mr-2 text-2xl font-bold text-white">Pending Documents</h1>
			...
			<div id="RECIEVED DOCUMENTS" class="flex w-fit items-center space-x-2 rounded-md border-l-8 border-green-700 bg-green-500 p-4 shadow-md">
				<div class="flex flex-col justify-between">
			...
			<div id="FORWARDED DOCUMENTS" class="flex w-fit items-center space-x-2 rounded-md border-l-8 border-green-700 bg-green-500 p-4 shadow-md">
				<div class="flex flex-col justify-between">
			...
			<div id="ACCEPTED DOCUMENTS" class="flex w-fit items-center space-x-2 rounded-md border-l-8 border-green-700 bg-green-500 p-4 shadow-md">
				<div class="flex flex-col justify-between">
		...
		<div class="grid--cols-1 mt-6 grid md:grid-cols-2">
			<div class="h-54 mt-12 flex w-full justify-center overflow-hidden bg-white">
