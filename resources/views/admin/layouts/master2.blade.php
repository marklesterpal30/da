    ...
    <div class="h-screen w-screen flex "> 
        ...
        <div class="sidebar bg-green-200 w-fit p-4  shadow-md rounded-sm">
            ...
            <ul class="text-left gitna">
                <li class=" {{ request()->is('dashboard') ? 'bg-green-600' : 'bg-green-600' }} mb-4 p-2 text-xl font-semibold rounded-md hover:bg-green-500 text-white shadow-xl"><a href="{{ url('/admin-dashboard') }}"><i class="fa-solid fa-gauge mr-2" style="color: #FFFF00;"></i><span class="menu-text">Dashboard</span></a></li>
                <li class="bg-green-600 mb-4 p-2 text-xl font-semibold rounded-md hover:bg-green-600 text-white"><a href="{{ url('/admin-incoming') }}"><i class="fa-solid fa-file-arrow-up mr-2" style="color: #62ea79;"></i><span class="menu-text">Incoming <span class="text-green-400 bg-white px-2 py-0.5 ml-2 rounded-md">{{$incomingCount}}</span></span></a></li>
                <li class="bg-green-600 text-white mb-4 p-2 text-xl font-semibold rounded-md hover:bg-green-500"><a href="{{ url('/admin-alldocuments') }}"><i class="fa-solid fa-file mr-2" style="color: #62ea79;"></i> <span class="menu-text">Active Documents</span></a></li>
                <li class="bg-green-600 text-white mb-4 p-2 text-xl font-semibold rounded-md hover:bg-green-500"><a href="{{ url('/admin-inactiveincoming') }}"><i class="fa-solid fa-file mr-2" style="color: #62ea79;"></i> <span class="menu-text">Inactive Documents</span></a></li>
                <li id="dropdownDefaultButton" data-dropdown-toggle="dropdown" data-dropdown-offset-skidding="30" class="bg-green-600  text-white mb-4 p-2 text-xl font-semibold rounded-md hover:bg-green-500 " type="button"><i class="fa-solid fa-file-arrow-down mr-1"></i> <span class="menu-text">Outgoing</span> 
                 </li>
                ...
                <li class="bg-green-600 text-white mb-4 p-2 text-xl font-semibold rounded-md hover:bg-green-500"><a href="{{ url('/admin-purpose') }}"><i class="fa-solid fa-file-pen mr-2" style="color: #7cf484;"></i><span class="menu-text">Purpose</span></a></li>
                ...
                <li class="bg-green-600 text-white mb-4 p-2 text-xl font-semibold rounded-md hover:bg-green-500"><a href="{{ url('/admin-records') }}"><i class="fa-solid fa-address-book mr-2" style="color: #358500;"></i><span class="menu-text">Records</span></a></li>
        ...
        <div class="flex flex-col w-full  overflow-hidden">
            ...
            <div class="w-full bg-green-400  h-20 flex items-center justify-between shadow-lg">
                    ...
                    <h1 class="mr-20 font-bold font-sans text-green-600 bg-white px-2 py-1 rounded-md capitalize">{{ Auth::user()->name }} <i class="fa-solid fa-angle-down font-bold"></i></h1>
            </div>
            <!-- CONTENT -->
